...
def post_to_linkedin(media_paths, caption, location=None, collaborators=None):
    ...
    logger.info(f"[💼] Preparing post with caption: {caption}")
    ...
    logger.info(f"[📡] Sending payload to Make.com webhook for post_type: {post_type}")
    try:
